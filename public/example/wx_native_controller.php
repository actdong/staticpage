...
class WxPayConfig
{
	 ...
	 * @var string
	 */
	const APPID = 'wx37316f798a3bd75c';
	const MCHID = '1229466802';
	const KEY = '20180110aixuebang20180110aixueba';
...
$input->SetTotal_fee($actual_amount);
$input->SetTime_start(date("YmdHis"));
$input->SetTime_expire(date("YmdHis", time() + 600));
$input->SetGoods_tag("test");
$input->SetNotify_url("https://172.28.94.32/example/notify.php");
$input->SetTrade_type("NATIVE");
$input->SetProduct_id($actual_product_id);
